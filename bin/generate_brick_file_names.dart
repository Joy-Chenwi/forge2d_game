      ...
      if (filtered.length == 5) {
        buff.writeln('''
                (BrickType.${type.toLowerCase()}, BrickSize.size${size.width}x${size.height}) => {
                    ...
                    BrickDamage.none: '${filtered.elementAt(1)}',
                    BrickDamage.none: '${filtered.elementAt(4)}',
                },
                ''');
        ...
        buff.writeln('''
                {
                    ...
                    BrickDamage.none: '${filtered.elementAt(4)}',
                    BrickDamage.none: '${filtered.elementAt(9)}',
                }
                ''');
        ...
        buff.writeln('''
                {
                    ...
                    BrickDamage.none: '${filtered.elementAt(8)}',
                    BrickDamage.none: '${filtered.elementAt(13)}',
                }
                ''');
      }
    }
